...
- [Beginner Level](#beginner-level) (Q1–5)
- [Intermediate Level](#intermediate-level) (Q6–10)
- [Advanced Level](#advanced-level) (Q11–15)
- [Solutions](#solutions) (Q1–15)
...
Write a program that extracts and prints lines containing a keyword (e.g., `"error"`) from a log file (`activity.log`).  
