...
- [🟢 Beginner Level (1–8)](#-beginner-level-1-8)
- [🟡 Intermediate Level (9–15)](#-intermediate-level-9-15)
- [🔴 Advanced Level (16–20)](#-advanced-level-16-20)
- [✅ Answers (compact recap of all 20)](#-answers)
...
```python
str1="Hello Friends, I am learning Python. I am a curious learner. I love coding and problem solving."
...
```python
PS C:\Users\yadav.deepak\Desktop\practise> & C:/Python312/python.exe c:/Users/yadav.deepak/Desktop/practise/test.py
.gnivlos melborp dna gnidoc evol I .renrael suoiruc a ma I .nohtyP gninrael ma I ,sdneirF olleH
.gnivlos melborp dna gnidoc evol I .renrael suoiruc a ma I .nohtyP gninrael ma I ,sdneirF olleH
PS C:\Users\yadav.deepak\Desktop\practise> 
...
```python
record_data = ('emp001', 'Engineer', 'Team-A')
record_data+= ('emp002',)
print(record_data)
```
...
dict1 = {'name': 'Alex'}
dict2 = {'role': 'Engineer', 'name': 'A. Smith'}
...
```python
sentence = "Effective teamwork practices improve collaboration and delivery speed"
...
```python
str1 = "mountainclimber"
str2 = "underestimating"
...
```python
PS C:\Users\yadav.deepak\Desktop\practise> & C:/Python312/python.exe c:/Users/yadav.deepak/Desktop/practise/test.py
Common characters in 'mountainclimber' and 'underestimating': {'a', 'e', 'i', 'm', 'n', 'r', 't', 'u'}
```
